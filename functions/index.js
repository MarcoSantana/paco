...
exports.incrementUsersCounter = authUserCountTrigger.onCreate(() =>
  updateRegisteredUserCount(+1),
)
exports.decrementUsersCounter = authUserCountTrigger.onDelete(() =>
  updateRegisteredUserCount(-1),
)
...
// Delete UserRequest
exports.deleteUserRequest = functions.https.onCall((data) => {
  return admin
    .firestore()
    .collection('events')
    .doc(data.requestId)
  ...
  await admin
    ...
    .then((querySnapshot) => {
      querySnapshot.forEach((doc) => {
        ...
        let graduationDate =
          doc.data().data.request.postgraduate.graduationDate || Date.now()
